...
import java from "../../assets/images/python2.jpg";
    ...
    <>
      <section className={cou.secMain}>
        <article className={cou.artMain}>
          ...
          <ul>
            <li>
              <h1>PythonCertification Training Course</h1>
            </li>
            <li>
              <p>
                industry benchmarks and curated by top industry experts.
                Eduxit's <br />
                online Python Course guide you to become a Oracle certified
                professional to clear Python <br /> SE8 programmer, Python SE11
