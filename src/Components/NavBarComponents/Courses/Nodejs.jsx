...
import java from "../../assets/images/node.webp";
    ...
    <>
      <section className={cou.secMain}>
        <article className={cou.artMain}>
          ...
          <ul>
            <li>
              <h1>Nodejs Certification Training Course</h1>
            </li>
            <li>
              <p>
                industry benchmarks and curated by top industry experts.
                Eduxit's <br />
                online Nodejs Course guide you to become a Oracle certified
                professional to clear Nodejs <br /> SE8 programmer, Nodejs SE11
                developer certification exam on the first attempt. This <br />{" "}
                Nodejs training online will give you extensive knowledge of Core
                Nodejs
              </p>
            </li>
            <li>
