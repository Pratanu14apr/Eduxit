...
import java from "../../assets/images/java22.webp";
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                Eduxit's <br />
                online Java Course guide you to become a Oracle certified
                professional to clear Java <br /> SE8 programmer, Java SE11
                developer certification exam on the first attempt. This <br />{" "}
                Java training online will give you extensive knowledge of Core
                Java
              </p>
            </li>
            <li>
